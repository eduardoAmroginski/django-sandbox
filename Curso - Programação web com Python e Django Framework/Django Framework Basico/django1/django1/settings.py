...
SECRET_KEY = 'django-insecure-fz#y^bgi%nf4on^w=8#yl!7&ov9!cd-z01xznaaj3avo32mx!f'
...
LOGOUT_REDIRECT_URL = 'index' # Quando houver logout no admin, redireciona para a página index